...
export default function ScreenSlider({setDisplaySize}:{setDisplaySize:Function}) {
  return (
    <Box w={["90%", "90", "120px", "120px"]} zIndex={"100"} position={["absolute", "absolute", "fixed", "fixed"]} top={["50px", "50px", "100px","100px"]} right={["auto", "auto", "170px","170px"]} left={["5vw", "5vw", "auto","auto"]}>
